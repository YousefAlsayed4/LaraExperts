...
namespace LaraExperts\Bolt\Tests;
...
use LaraExperts\Bolt\BoltServiceProvider;
use LaraExperts\Bolt\Tests\Models\User;
...
class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'LaraExperts\\Bolt\\Database\\Factories\\' . class_basename($modelName) . 'Factory'
        );
    }
