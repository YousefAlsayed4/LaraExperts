...
use LaraExperts\Bolt\Models\Category;
...
trait Schemata
{
                    ...
                    ->reject(function ($item, $key) use ($arguments) {
                        return $key === $arguments['item'] ||
                            ! (
                                ...
                                $item['type'] === '\LaraExperts\Bolt\Fields\Classes\Toggle'
                            );
                    })->all();
    ...
    public static function getMainFormSchema(): array
    {
        return [
            ...
            Repeater::make('sections')
                ...
                ->extraItemActions([
                    // @phpstan-ignore-next-line
                    // Bolt::hasPro() ? \LaraExperts\BoltPro\Actions\SectionMarkAction::make('marks') : null,
    ...
    public static function getTabsSchema(): array
    {
        $tabs = [
            ...
            Tabs\Tab::make('design')
                ->label(__('Design'))
                // ->visible(Bolt::hasPro() && config('form-bolt.allow_design'))
                ->schema([
                    // ViewField::make('options.primary_color')
                    //     ->hiddenLabel()
                    //     ->view('form::filament.components.color-picker'),
                    FileUpload::make('options.logo')
                        ->disk(config('form-bolt.uploadDisk'))
    ...
    public static function getSectionsSchema(): array
    {
        return array_filter([
            ...
            Repeater::make('fields')
                ...
                ->extraItemActions([
                    // @phpstan-ignore-next-line
                    // Bolt::hasPro() ? \LaraExperts\BoltPro\Actions\FieldMarkAction::make('marks') : null,
    ...
    {
        return
            view('form::filament.fields.types')
                ->with('field', $field)
                ->render();
    }
    ...
    public static function getFieldsSchema(): array
    {
        return [
            ...
            Select::make('type')
                ...
                ->live()
                ->default('\LaraExperts\Bolt\Fields\Classes\TextInput')
                ->label(__('Field Type')),
            Group::make()
