...
namespace LaraExperts\Bolt\Filament\Actions;
...
use LaraExperts\Bolt\Models\Form as Form;
...
class ReplicateFormAction extends Action implements ReplicatesRecords
{
    ...
    protected function setUp(): void
    {
        ...
        $this->icon(FilamentIcon::resolve('actions::replicate-action') ?? 'heroicon-m-square-2-stack')
            ...
            ->beforeReplicaSaved(function (Form $replica, Form $record, array $data): void {
