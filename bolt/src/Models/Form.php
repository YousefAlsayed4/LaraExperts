...
use LaraExperts\Bolt\Concerns\HasActive;
use LaraExperts\Bolt\Concerns\HasUpdates;
use LaraExperts\Bolt\Database\Factories\FormFactory;
...
class Form extends Model
{
    ...
    {
        return config('form-bolt.table-prefix') . 'forms';
    }
    ...
    {
        return $this->belongsTo(config('form-bolt.models.Category'));
    }

    /** @phpstan-return hasMany<Section> */
    public function sections(): HasMany
    {
        return $this->hasMany(config('form-bolt.models.Section'));
    }

    /** @phpstan-return hasManyThrough<Field> */
    public function fields(): HasManyThrough
    {
        return $this->hasManyThrough(config('form-bolt.models.Field'), config('form-bolt.models.Section'));
    }

    /** @phpstan-return hasMany<Response> */
    public function responses(): hasMany
    {
        return $this->hasMany(config('form-bolt.models.Response'));
    }
